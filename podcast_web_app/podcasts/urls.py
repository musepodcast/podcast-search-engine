...
urlpatterns = [
    ...
    path('channel/<int:channel_id>/update_rating/', views.update_channel_rating, name='update_channel_rating'),
    path('channel/<int:channel_id>/rating_summary.json', views.channel_rating_summary, name='channel_rating_summary'),
